...
class addaplicacao extends Component {
  ...
  handleSubmitAgenamento = async (e) => {
    ...
    await api
      .post("schedule", { doses, scheduling_date, vaccine_id, user_id })
      .then(function () {})
      .catch(function (err) {
  ...
  render() {
    const { doses, scheduling_date, vaccine_id } = this.state;
                        ...
                        <FormGroup row>
                          ...
                          <Col xs="12" md="9">
                            <Input
                              ...
                              value={doses}
                              onChange={(e) =>
                                this.setState({ doses: e.target.value })
                              }
                            >
                        ...
                        <FormGroup row>
                          ...
                          <Col xs="12" md="9">
                            <Input
                              ...
                              value={vaccine_id}
                              onChange={(e) =>
                                this.setState({ vaccine_id: e.target.value })
                              }
                            >
